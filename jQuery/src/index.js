          ...
          },
          {
            ...
            label: {
              template: (data, element) => {
                const lineBreak = '<br>';
                const infoIcon = '<i id="helped-info" class="dx-icon dx-icon-info"></i>';
      ...
      toolbarItems: [
        {
          ...
          onClick: () => {
            ...
            const gridStore = gridSource.store();
            if (isNewRecord) gridStore.insert(data);
            else gridStore.update(data.ID, data);
            grid.refresh(true);
            popup.hide();
          },
        },
